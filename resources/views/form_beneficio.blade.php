            ...
            <div class="col-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('create_empleado')}}" method="post" id="form_bene">
                            @csrf 
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" name="cedula" class="form-control input-number" maxlength="8" minlength="7" required>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                    <label for="">Apellidos y Nombres</label>
                                    <input type="text" class="form-control input-char" name="apellido_nombre" required>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                    <label for="">Fecha de Nacimiento</label>
                                    <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control" onchange="edad_e()" placeholder ="Fecha de Nacimiento" required>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="row" style="margin-top:15px">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" name="n_cuenta" class="form-control" required>
                            </div>
                        </div>
                        <div class="row" style="margin-top:15px">
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                    <label for="">Cargo en el Sistema</label>
                                    <input type="text" name="cargo_sistema" class="form-control" required>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" name="profesionalizacion" class="form-control" required>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                    <label for="">Años en la Administración Pública</label>
                                    <input type="text" name="anios_administracion" maxlength="2" minlength="2" class="form-control input-number" required>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-top:10px">
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" name="direccion" placeholder =" " class="form-control" required>
                            </div>    
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    {{-- <input type="text" name="talla_camisa" class="form-control" required> --}}
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" name="talla_pantalon" class="form-control input-number" maxlength="2" minlength="2" required>
                            </div>
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                    <label for="">Talla de Zapato</label>
                                    <input type="text" name="talla_zapato" class="form-control input-number" maxlength="2" minlength="2" required>
                            </div>
                        </div>     
                                <div style="padding:15px">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" name="n_familiares" class="form-control input-number" maxlength="1" minlength="1" required>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function(){
        $("#estado").change(function(){
          var estado = $(this).val();
            $.get('municipioSearch/'+estado, function(data){
        ...
        $("#municipio").change(function(){
          var municipio = $(this).val();
            $.get('parroquiaSearch/'+municipio, function(data){
...
// function edad_carga(){
//     let fechaNacimiento = document.getElementById("fecha_de_nacimiento").value;
//     let fechaActual = new Date();
//     let anoActual = parseInt(fechaActual.getFullYear());
//     let mesActual = parseInt(fechaActual.getMonth()) + 1;
//     let diaActual = parseInt(fechaActual.getDate());
...
//     console.log(edad);
//     $("#edad_hijo").val(edad);
//     document.getElementById("edad_hijo").setAttribute('readonly', '');
//     return edad;
// };
